...
<html lang="en">
  ...
  <body>
        ...
        <section id="project">
          <div class="container">
            <div class="row text-center">
              <div class="col">
                <h2>6 Area Perubahan Zona Integritas</h2><br>
                <img src="img/ziwbb.jpg" width="750" alt="">
              </div>
            </div>
            
            <div class="row justify-content text-left my-5">
    ...
    c. Meningkatnya kinerja di Zona Integritas menuju WBK/WBBM.
      ...
      <section id="6 Area Perubahan">
        <div class="container">
          <div class="row text-center mt-5 pt-4 mb-4">
            <div class="col">
            </div>
          </div>
